...
def get_db_connection_sic():
    ...
    # SQL Server connection details
server1 = 'srv-commercial'  # Replace with your server name or IP
database1 = 'HISTH2MC'   # Replace with your database name
username1 = 'commercial_dev'       # Replace with your SQL Server username
password1 = 'Senelec2023'  # Replace with your password
driver1 = '{ODBC Driver 18 for SQL Server}'  # Adjust based on your installed driver
